...
;================================================================================
; Direct SRAM Assignments ($A06000 - $A08000)
;--------------------------------------------------------------------------------
...
;--------------------------------------------------------------------------------
%assertSRAM(CartridgeSRAM, $A06000)
%assertSRAM(RoomDataSRAM, $A06000)
%assertSRAM(OverworldEventDataSRAM, $A06280)
%assertSRAM(EquipmentSRAM, $A06340)
%assertSRAM(BombsEquipmentSRAM, $A06343)
%assertSRAM(DisplayRupeesSRAM, $A06362)
%assertSRAM(CurrentArrowsSRAM, $A06377)
%assertSRAM(InventoryTrackingSRAM, $A0638C)
%assertSRAM(BowTrackingSRAM, $A0638E)
%assertSRAM(ProgressIndicatorSRAM, $A063C5)
%assertSRAM(FileNameVanillaSRAM, $A063D9)
%assertSRAM(FileValiditySRAM, $A063E1)
%assertSRAM(InverseChecksumSRAM, $A064FE)
%assertSRAM(ExtendedFileNameSRAM, $A06500)
%assertSRAM(RomVersionSRAM, $A07FFC)
